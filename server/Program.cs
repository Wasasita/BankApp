...
// ========================================================
User? HandleConsoleLogin(List<User> database)
{
    Console.Clear();
...
// ========================================================
void AdminDashboard(Admin currentAdmin, List<Customer> customerDatabase)
{
    bool inAdmin = true;
    while (inAdmin)
    {
...
// ========================================================
void CustomerDashboard(Customer currentCustomer, List<Customer> customerDatabase, ref int globalAccountSequence)
{
